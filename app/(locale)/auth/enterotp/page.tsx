      ...
      <div className='w-full h-full flex flex-col justify-center items-center text-left'>
        <div className='md:w-[562px] sm:w-fit h-fit p-4 '>
          ...
          <CommonInput
            ...
            type='password'
          />
          <button className='w-full bg-primary-500 border rounded-lg text-theme p-4 text-xl mt-4'>{t('signUp')}</button>
          <div className='border rounded-lg p-4 mt-6 flex items-center justify-center'>
            <span>{t('signalreadyHaveAccountUp')}</span>
            <Link href={'/'} className='text-primary-500 mx-2'>
              {t('login')}
            </Link>
          </div>
        </div>
