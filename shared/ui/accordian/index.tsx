	...
	return (
		<div
			...
			<div className={'text-base mt-2 select-none cursor-pointer flex items-center justify-between z-10 text-secondary-500'}>
				{title}
				<div className={`w-5 transition-all ${isActive ? 'rotate-180' : ''}`}>
			...
			<div
				...
				className={
					isActive
						? 'transition-all  rounded-b-2xl py-4 opacity-1'
						: 'transition-all  overflow-hidden h-0 max-h-0 z-0 animate-close'
				}>
				{body}
			</div>
		</div>
